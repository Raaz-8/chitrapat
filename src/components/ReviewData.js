...
const ReviewData = ({ movie_id, prevRating, userRated }) => {
  ...
  return (
    <div className="mt-4 w-full border-t-2 border-red-200 pt-2 border-opacity-30 ">
      ...
      <div className="flex items-center max-sm:flex-col max-sm:items-start max-sm:mt-2">
        <p className="text-gray-500">Select Stars to give rating : </p>
        <ReactStars
        ...
        <div className="hidden">
          {data.map((e, i) => {
            return (
              <div
                key={i}
                className=" border-b border-gray-600 mt-6 bg-gray-700 bg-opacity-30 p-2"
              >
                <div className="flex justify-between items-center">
                  <p className="pb-2 text-blue-500 font-semibold">
                    {e.user_email}
                  </p>
